...
(function (factory) {
    ...
    Highcharts.Chart.prototype.getDataRows = function () {
        ...
        dataRows = ModificarTamaño(dataRows);

        return dataRows;
    };


    //funcion para recalcular columnas
    function ModificarTamaño(dataRows) {
        var rowArr = [];
        //rowArr.push(dataRows[0][0], dataRows[0][3]);
        var longitud = dataRows.length;
        var aux = [0, 0];
        //var aux1 = [];
        var i;
        for (i = 0; i < longitud; i++) {
            aux = [dataRows[i][0], dataRows[i][3]];
            //aux1 = dataRows[i][3];
            rowArr.push(aux);
            //rowArr = rowArr.concat(aux);
            aux = [];
        }
        return rowArr;
    }
