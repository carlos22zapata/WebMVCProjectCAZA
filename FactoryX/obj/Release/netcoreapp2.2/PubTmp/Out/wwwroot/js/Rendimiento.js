...
function obtenerMes(idEmpresa) {
    ...
    animacionWW('A');
    //alert(ffin_);
    GetRendimiento(idEmpresa, finiM, ffinM, "mes", "", sku);
...
function obtenerSemana(idEmpresa) {
    ...
    animacionWW('A');
    GetRendimiento(idEmpresa, fini_, ffin_, "semana", tur, sku);
...
function obtenerDia(idEmpresa) {
    ...
    animacionWW('A');
    GetRendimiento(idEmpresa, fini_, ffin_, "dia", turno, sku);
}
...
function obtenerHora(idEmpresa) {
    ...
    animacionWW('A');
    GetRendimiento(idEmpresa, fini_, ffin_, "hora", "", sku);

}

function GetRendimiento(idEmpresa, fini_, ffin_, filtro, turno, sku, inicio) {

    $.ajax({
        type: "POST",
        url: FactoryX.Urls.IndicadorRendimiento, //IndicadorRendimiento //GetRendimiento,
...
function Grafico_disponibilidad(data) {
    ...
    Highcharts.chart('container', {
        ...
        colors: ['#e81e62', '#663ab6', '#90ee7e', '#7798BF', '#aaeeee', '#ff0066',
...
$(document).ready(function () {
    ...
    GetRendimiento(idEmpresa, Dfini, Dffin, filtro, turno, sku, inicio);
});
