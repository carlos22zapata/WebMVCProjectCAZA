...
//function mostrar() {
//    a = document.getElementById('arbol_menu');
//    a.style.left = "10";
//}

//function openNav() {
//	document.getElementById("arbol_menu").style.width = "270px";
//	//document.getElementById("main").style.marginLeft = "270px";
//	document.getElementById("simple-treeview").style.marginLeft = "270px";
//	document.getElementById("product-details").style.marginLeft = "270px";
//	//document.getElementById("cuadro3").style.marginLeft = "270px";
//	//document.getElementById("cuadro4").style.marginLeft = "270px";
//}

///* Set the width of the sidebar to 0 and the left margin of the page content to 0 */
//function closeNav() {
//	document.getElementById("arbol_menu").style.width = "0";
//	//document.getElementById("main").style.marginLeft = "0";
//	document.getElementById("simple-treeview").style.marginLeft = "0";
//	document.getElementById("product-details").style.marginLeft = "0";
//	//document.getElementById("cuadro3").style.marginLeft = "0";
//	//document.getElementById("cuadro4").style.marginLeft = "0";
//}

//function accionBoton() {
//	//console.log(document.getElementById("mySidebar").style.width);
//	if (document.getElementById("arbol_menu").style.width === "") {
//		document.getElementById("arbol_menu").style.width = "0px";
//	}
//	//console.log(document.getElementById("mySidebar").style.width);
//	if (document.getElementById("arbol_menu").style.width === "0px") {
//		//console.log(document.getElementById("botonMain").innerHTML);
//		openNav();
//		document.getElementById("botonMain").innerHTML = "&#11077";
//	}
//	else {

//		closeNav();
//		document.getElementById("botonMain").innerHTML = "&#11078";
//	}
//}
	...
	var tree = {
				...
				if (p_parentNode === undefined) {
					...
					if (p_parentNode.childNodes.length === 0) {
						if (p_parentNode.expanded) {
							...
							v_img.src = '/Images/tree_images/menos.png';
							v_img.id = 'toggle_off';
						}
						else {
							...
							v_img = p_parentNode.elementLi.getElementsByTagName("img")[0];
							v_img.style.visibility = "visible";
							v_img.src = '/Images/tree_images/mas.png';
							v_img.id = 'toggle_on';
						}
					}
		...
		drawNode: function (p_ulElement, p_node) {
			...
			if (p_node.childNodes.length === 0) {
				v_exp_col = createImgElement('toggle_off', 'exp_col', '/Images/tree_images/menos.png');
				...
				if (p_node.expanded) {
					...
					v_exp_col = createImgElement('toggle_on', 'exp_col', '/Images/tree_images/mas.png');
				}
			}
		...
		expandNode: function (p_node) {
			if (p_node.childNodes.length > 0 && p_node.expanded === false) {
				...
				img.id = "toggle_off";
				img.src = '/Images/tree_images/menos.png';
		...
		collapseNode: function (p_node) {
			if (p_node.childNodes.length > 0 && p_node.expanded === true) {
				...
				img.id = "toggle_on";
				img.src = '/Images/tree_images/mas.png';
				elem_ul = img.parentElement.getElementsByTagName("ul")[0];
				...
				if (p_node.contextMenu !== undefined) {
					...
					for (var i = 0; i < v_menu.elements.length; i++) (function (i) {
						...
						if (v_menu.elements[i].submenu !== undefined) {
							...
							v_span_more.appendChild(createImgElement(null, 'menu_img', '/Images/tree_images/right.png'));
...
window.onload = function () {
	...
	var contex_menu = {
		'context1': {
			elements: [
				{
					text: 'Node Actions',
					icon: '/Images/tree_images/blue_key.png',
					...
					submenu: {
						elements: [
							{
								text: 'Toggle Node',
								icon: '/Images/tree_images/leaf.png',
								action: function (node) {
									node.toggleNode();
								}
							},
							...
							{
								text: 'Expand Subtree',
								icon: '/Images/tree_images/tree.png',
								action: function (node) {
									node.expandSubtree();
								}
							},
							...
							{
								text: 'Delete Node',
								icon: '/Images/tree_images/delete.png',
								action: function (node) {
									node.removeNode();
								}
							},
						...
						elements: [
							{
								...
								icon: '/Images/tree_images/add1.png',
								action: function (node) {
	...
	//Creating the tree
	tree = createTree('div_tree', '#6AACBB;', contex_menu);
	...
	//Estrucuta del árbol
	//node1 = tree.createNode('EMPRESA DEMOSTRACIÓN', false, 'images/magic_ball.png', null, null, 'context1');
	node1 = tree.createNode('Planificación', false, null, null, 'context1');
	node2 = tree.createNode('Monitoreo', false, null, null, 'context1');
	node3 = tree.createNode('Analítica', false, null, null, 'context1');
	node31 = node3.createChildNode('Disponibilidad', false, null, 'context1');
	node32 = node3.createChildNode('Rendimiento', false, null, 'context1');
	node33 = node3.createChildNode('Calidad', false, null, 'context1');
	node4 = tree.createNode('Mejora Continua', false, null, null, 'context1');
	//node2 = node1.createChildNode('Planificación', false, 'images/folder.png', null, 'context1');
	//node3 = node1.createChildNode('Monitoreo', false, 'images/folder.png', null, 'context1');
	//	//node31 = node3.createChildNode('Línea 1', false, 'images/folder.png', null, 'context1');
	//	//	node311 = node31.createChildNode('Máquina 1.1', false, 'images/folder.png', null, 'context1');
	//	//		node3111 = node311.createChildNode('Resumen', false, 'images/monitor.png', null, 'context1');
	//	//		node3112 = node311.createChildNode('Contador', false, 'images/monitor.png', null, 'context1');
	//	//		node3113 = node311.createChildNode('Temperatura', false, 'images/monitor.png', null, 'context1');
	//	//		node3114 = node311.createChildNode('Humedad', false, 'images/monitor.png', null, 'context1');
	//	//	node312 = node31.createChildNode('Máquina 1.2', false, 'images/folder.png', null, 'context1');
	//	//		node3121 = node312.createChildNode('Resumen', false, 'images/monitor.png', null, 'context1');
	//	//		node3122 = node312.createChildNode('Contador', false, 'images/monitor.png', null, 'context1');
	//	//		node3123 = node312.createChildNode('Temperatura', false, 'images/monitor.png', null, 'context1');
	//	//		node3124 = node312.createChildNode('Humedad', false, 'images/monitor.png', null, 'context1');
	//	//		node3125 = node312.createChildNode('Apagado/Encendido', false, 'images/monitor.png', null, 'context1');
	//	//node32 = node3.createChildNode('Línea 2', false, 'images/folder.png', null, 'context1');
	//	//	node321 = node32.createChildNode('Máquina 2.1', false, 'images/folder.png', null, 'context1');
	//	//		node3211 = node321.createChildNode('Resumen', false, 'images/monitor.png', null, 'context1');
	//	//		node3212 = node321.createChildNode('Contador', false, 'images/monitor.png', null, 'context1');
	//	//		node3213 = node321.createChildNode('Temperatura', false, 'images/monitor.png', null, 'context1');
	//node4 = node1.createChildNode('Analítica', false, 'images/folder.png', null, 'context1');
	//	node41 = node4.createChildNode('Disponibilidad', false, 'images/folder.png', null, 'context1');
	//	node42 = node4.createChildNode('Rendimiento', false, 'images/folder.png', null, 'context1');
	//	node43 = node4.createChildNode('Calidad', false, 'images/folder.png', null, 'context1');
	//node5 = node1.createChildNode('Mejora Continua', false, 'images/folder.png', null, 'context1');
	//node6 = node1.createChildNode('Registro de Operaciones', false, 'images/folder.png', null, 'context1');
	//node7 = node1.createChildNode('Tablas Maestras', false, 'images/folder.png', null, 'context1');
	//node8 = node1.createChildNode('Configuración', false, 'images/folder.png', null, 'context1');
...
function openNav() {
	...
	document.getElementById("main").style.marginLeft = "270px";
	document.getElementById("cuerpoPrincipal").style.marginLeft = "270px";
	//document.getElementById("cuadro2").style.marginLeft = "270px";
	//document.getElementById("cuadro3").style.marginLeft = "270px";
	//document.getElementById("cuadro4").style.marginLeft = "270px";
}
...
function closeNav() {
	...
	document.getElementById("main").style.marginLeft = "0";
	document.getElementById("cuerpoPrincipal").style.marginLeft = "0";
...
function accionBoton() {
	...
	if (document.getElementById("mySidebar").style.width === "0px") {
		//console.log(document.getElementById("botonMain").innerHTML);
		openNav();
		//document.getElementById("botonMain").innerHTML = "fas fa-chevron-right";
	}
	else {
